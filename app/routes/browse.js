...
if (category==="education")
      {
          ...
          var Campaign = new Ember.Object();
         
        
          Category.id = "1";
          Category.title = "Education";
          Category.tagline = "Made Easy";
          Category.description = "Crowdfunding is an online fundraising and crowdfunding platform. We help individuals, non-profits, social enterprises, and corporates to raise money online for social or personal projects.";
          campaign.id = "The destination type is larger than source type";
